...
$route['users/update/(:any)'] = 'users/UsersController/update/$1';
$route['users/delete/(:any)'] = 'users/UsersController/delete/$1';
$route['users/detail/(:any)'] = 'users/UsersController/detail/$1';
...
$route['order/detail/(:any)'] = 'order/OrderController/detail/$1';
//$route['order/accept/(:any)'] = 'order/OrderController/accept/$1';
$route['order/reject/(:any)/(:any)'] = 'order/OrderController/reject/$1/$2';
$route['order/invoice/(:any)/(:any)'] = 'order/OrderController/invoice/$1/$2';

$route['login'] = 'AccessController';
$route['logout'] = 'AccessController/logout';

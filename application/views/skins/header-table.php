...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href=""><span>[</span>SAWA<i>DIKAP</i><span>]</span></a></div>
    <div class="br-sideleft sideleft-scrollbar">
      <label class="sidebar-label pd-x-10 mg-t-20 op-3">Navigation</label>
      <ul id="menu" class="br-sideleft-menu">
        <li class="br-menu-item">
          <a href="<?php echo base_url()?>" class="br-menu-link <?php if ($this->uri->segment(1) == '') echo "active" ?>">
            <i class="menu-item-icon icon ion-ios-home-outline tx-24"></i>
            <span class="menu-item-label">Dashboard</span>
          </a><!-- br-menu-link -->
        </li><!-- br-menu-item -->
        <li class="br-menu-item">
          <a href="<?php echo base_url()."users"?>" class="br-menu-link <?php if ($this->uri->segment(1) == 'users') echo "active" ?>">
            <i class="menu-item-icon icon ion-ios-people tx-24"></i>
            <span class="menu-item-label">Users</span>
          </a><!-- br-menu-link -->
        </li><!-- br-menu-item -->
        <li class="br-menu-item">
          <a href="<?php echo base_url()."product"?>" class="br-menu-link <?php if ($this->uri->segment(1) == 'product') echo "active" ?>">
            <i class="menu-item-icon icon ion-bag tx-24"></i>
            <span class="menu-item-label">Pakaian</span>
          </a><!-- br-menu-link -->
        </li><!-- br-menu-item -->
		  <li class="br-menu-item">
			  <a href="<?php echo base_url()."project"?>" class="br-menu-link <?php if ($this->uri->segment(1) == 'project') echo "active" ?>">
				  <i class="menu-item-icon icon ion-image tx-24"></i>
				  <span class="menu-item-label">Projects</span>
			  </a><!-- br-menu-link -->
		  </li><!-- br-menu-item -->
		  <li class="br-menu-item">
			  <a href="<?php echo base_url()."career"?>" class="br-menu-link <?php if ($this->uri->segment(1) == 'career') echo "active" ?>">
				  <i class="menu-item-icon icon ion-camera tx-24"></i>
				  <span class="menu-item-label">Request Pakaian</span>
			  </a><!-- br-menu-link -->
		  </li><!-- br-menu-item -->
        <li class="br-menu-item">
          <a href="<?php echo base_url()."order"?>" class="br-menu-link <?php if ($this->uri->segment(1) == 'order') echo "active" ?>">
            <i class="menu-item-icon icon ion-cash tx-24"></i>
            <span class="menu-item-label">Request Pick-up</span>
          </a><!-- br-menu-link -->
        </li><!-- br-menu-item -->
      </ul><!-- br-sideleft-menu -->
